...
shown are handled with [`normalization_context`](../serialization/index.md#normalization), while the properties
you can modify are handled with [`denormalization_context`](../serialization/index.md#the-serialization-context-groups-and-relations).
