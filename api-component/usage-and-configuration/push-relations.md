...
For best performance, this feature should be used in conjunction with [the built-in HTTP cache invalidation system (based on Varnish)](../caching-performance-optimization/cache.md#enabling-the-built-in-http-cache-invalidation-system).
