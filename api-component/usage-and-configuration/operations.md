...
The behavior of built-in operations is briefly presented in the [Getting started](../../api-component/getting-started/mapping-the-entities.md)
guide.
...
when [using the JSON API format](../getting-started/content-negotiation.md), as required by the specification).
...
Note: the `PATCH` method must be enabled explicitly in the configuration, refer to the [Content Negotiation](../getting-started/content-negotiation.md) section for more information.
