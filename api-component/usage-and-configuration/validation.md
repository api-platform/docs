...
for this task, but you can replace it with your preferred validation library such as [the PHP filter extension](https://php.net/manual/en/intro.filter.php) if you want to.
...
Like for [serialization groups](../serialization/index.md),
...
[callable](https://php.net/manual/en/language.types.callable.php). The callback will receive the entity object as its first
...
Note: this is related to the [collection relation denormalization](../serialization/embed-relations.md#collection-relations).
