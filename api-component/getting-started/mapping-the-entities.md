...
This isn't mandatory. You can use [your preferred persistence](../fetching-and-persisting-data/data-providers.md) and [validation](../usage-and-configuration/validation.md) systems.
...
Thanks to the mapping done previously, API Platform Core will automatically register the following REST [operations](../usage-and-configuration/operations.md)
...
It is also possible to override the naming convention using [operation path namings](../how-do-i/operation-path-naming.md).
...
If you want to serialize only a subset of your data, please refer to the [Serialization documentation](../serialization/index.md).
