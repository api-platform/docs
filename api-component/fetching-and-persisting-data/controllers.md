...
[For most use cases, better extensions points, working both with REST and GraphQL, are available](../usage-and-configuration/design.md).
...
Symfony controllers extending the [`Symfony\Bundle\FrameworkBundle\Controller\AbstractController`](https://api.symfony.com/4.1/Symfony/Bundle/FrameworkBundle/Controller/AbstractController.html)
helper class.
...
See the [OpenAPI](../documenting-specifying-your-api/swagger.md) part of the documentation to do so.
...
In this case, the entity will pass through [all built-in event listeners](../usage-and-configuration/events.md#built-in-event-listeners) of API Platform. It will be
...
This way, it will skip the `ReadListener`. You can do the same for some other built-in listeners. See [Built-in Event Listeners](../usage-and-configuration/events.md#built-in-event-listeners)
