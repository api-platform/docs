...
To mutate the application states during `POST`, `PUT`, `PATCH` or `DELETE` [operations](../usage-and-configuration/operations.md), API Platform uses
...
process](../serialization/index.md).
