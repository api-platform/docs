...
See how to use Elasticsearch filters and how to create Elasticsearch custom filters in [the Filters chapter](../pagination-filters-sorting/custom.md#creating-custom-elasticsearch-filters).
