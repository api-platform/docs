...
For an overview of how to test an API Platform app, be sure to read [the testing cookbook first](index.md).
...
Install the `symfony/http-client` and `symfony/browser-kit` packages to enable the API Platform test client:
    ...
    $ composer require --dev symfony/http-client symfony/browser-kit
