...
Then, create some fixtures for [the bookstore API you created in the tutorial](../../distribution/index.md):
...
Here is an example of functional tests specifying the behavior of [the bookstore API you created in the tutorial](../../distribution/index.md):
...
Check out the [testing documentation](utilities.md) to discover the full range of assertions and other features provided by API Platform's test utilities.
