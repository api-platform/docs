...
You can also get an older version thanks to the `spec_version` query parameter: `/docs.json?spec_version=2`
...
$ bin/console api:openapi:export --spec-version=3
# OpenAPI v3, JSON format

$ bin/console api:openapi:export --spec-version=3 --yaml
