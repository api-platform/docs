...
16. [Security](core/security.md)
  1. [Adding a JWT authentication using LexikJWTAuthenticationBundle](core/jwt.md)
  2. [Protect Documentation with Authentification](core/jwt.md#protect-documentation-with-same-authentification)
  3. [Complete Documentation with Auth System](core/jwt.md#complete-documentation-with-auth-system)
