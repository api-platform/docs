...
9. [Content Negotiation](core/content-negotiation.md)
  ...
  2. [Registering a Custom Format in the Negotiation Library](core/content-negotiation.md#registering-a-custom-format-in-the-Negotiation-library)
  3. [Registering a Custom Serializer](core/content-negotiation.md#registering-a-custom-serializer)
  4. [Creating a Responder](core/content-negotiation.md#creating-a-responder)
