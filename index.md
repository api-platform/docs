...
16. [Performance](core/performance.md)
...
17. [Operation Path Naming](core/operation-path-naming.md)
...
18. [Accept `application/x-www-form-urlencoded` Form Data] (core/form-data.md)
19. [FOSUserBundle Integration](core/fosuser-bundle.md)
...
20. [NelmioApiDocBundle integration](core/nelmio-api-doc.md)
21. [AngularJS Integration](core/angularjs-integration.md)
