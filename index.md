...
7. [The Serialization Process](core/serialization.md)
    ...
    4.  [Using Different Serialization Groups per Operation](core/serialization.md#embedding-relations)
    5.  [Embedding Relations](core/serialization.md#embedding-relations)
        1.  [Normalization](core/serialization.md#normalization)
    ...
    7.  [Name Conversion](core/core/serialization.md#name-conversion)
    8.  [Entity Identifier Case](core/core/serialization.md#entity-identifier-case)
    9.  [Writable Entity Identifier](core/core/serialization.md#writable-entity-identifier)
    10.  [Embedding the JSON-LD Context](core/core/serialization.md#embedding-the-json-ld-context)
    11.  [Decorating a Serializer and Add Extra Data](core/serialization.md#decorating-a-serializer-and-add-extra-data)
