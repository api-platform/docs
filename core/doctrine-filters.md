...
Useful filters for Doctrine ORM are provided with the library.
...
For further documentation on filters (including one for Laravel), please see the [Filters documentation](filters.md).
