...
7. [Resources path generators](resource-path-generator.md)
  1. [Configuration](resource-path-generator.md#configuration)
  2. [Create a custom path generator](resource-path-generator.md#create-a-custom-path-generator)
    1. [Defining the Resource Path Generator](resource-path-generator.md#defining-the-resource-path-generator)
    2. [Registering the service](resource-path-generator.md#registering-the-service)
    3. [Configure it](resource-path-generator.md#configure-it)
