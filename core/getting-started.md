...
If you are starting a new project, the easiest way to get API Platform up is to install the [API Platform Laravel Variant](../laravel/index.md).
...
If you are starting a new project, the easiest way to get API Platform up is to install the [API Platform Symfony Variant](../symfony/index.md).
...
You may want to run a minimal version of API Platform (without GraphQL, Eloquent, Doctrine MongoDB…), use the [Bootstraping the core library documentation](../core/bootstrap.md).
...
These tutorials covers basic concepts required to understand how API Platform works including how it implements the REST pattern
